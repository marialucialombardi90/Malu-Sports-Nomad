...
import bookonlinebanner from "../Images/bookonlinebanner.jpg";
...
const OnlineBookingPage = () => {
  ...
  useEffect(() => {
    ...
    if (filters.period !== "All") {
      filtered = filtered.filter(
        (facility) => facility.period === filters.period
      );
    }
  ...
  const handlePageChange = (id, data) => {
    navigate(`/online-booking/${id}`, { state: { data } });
  };
  return (
    <div>
      <Header />
      <div className="min-h-[calc(100vh-356px)]">
        <section
          ...
          style={{
            backgroundImage: `url(${bookonlinebanner})`,
        ...
        <section className="py-12">
          <div className="container mx-auto px-4">
            ...
            <form
              className="flex flex-col flex-wrap lg:flex-row gap-3 py-4 justify-center"
              onSubmit={(e) => {
                e.preventDefault();
              }}
            >
              <div className="flex w-full">
                <input
                  ...
                  className="text-accent-600 w-full px-3 h-10 rounded-l border-2 border-primary-500 focus:outline-none focus:border-primary-500 focus:ring-0 transition-all duration-300"
                />
                <button
                  type="submit"
              ...
              <select
                id="period"
                name="period"
                value={filters.openHours}
                onChange={handleFilterChange}
                className="w-full lg:w-64 h-10 border-2 border-primary-500 focus:outline-none focus:border-primary-500 focus:ring-0 text-accent-600 rounded px-3 py-0 tracking-wider bg-white transition-all duration-300 "
              >
                <option value="All" selected="">
                  {t("global.filters.price_per_period")}
                </option>
                  ...
                  {currentFacilities.map((facility) => (
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <button
                          onClick={() =>
                            handlePageChange(facility._id, facility)
                          }
